<?php /*a:1:{s:60:"D:\xiaomiShop\MilletShop\application/index/view\.\index.html";i:1599447807;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
	...
	<!-- start header -->
		<header>
			<div class="top center">
				...
				<div class="right fr">
					<div class="gouwuche fr"><a href="/Index/Catshop/index"  target="_blank">购物车</a></div>
					<div class="fr">
						<ul>
							<li><a href="/Index/index/login" target="_blank">登录</a></li>
							<li>|</li>
							<li><a href="/Index/index/register" target="_blank" >注册</a></li>
							<li>|</li>
							<li><a href="">消息通知</a></li>
						</ul>
					</div>
...
<!-- start banner_x -->
		<div class="banner_x center">
			...
			<div class="nav fl">
				<ul>
					<li><a href="/Index/index/liebiao" target="_blank">小米手机</a></li>
					<li><a href="">红米</a></li>
						...
						<div class="pop">
							<div class="left fl">
								<div>
									...
									<div class="xuangou_right fr"><a href="/Index/Index/xianqing" target="_blank">选购</a></div>
									<div class="clear"></div>
								</div>
								<div>
									<div class="xuangou_left fl">
								...
								<div>
									...
									<div class="xuangou_right fr"><a href="/Index/Index/xianqing">选购</a></div>
									<div class="clear"></div>
								</div>
								<div>
									<div class="xuangou_left fl">
